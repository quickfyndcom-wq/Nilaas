...
export const DEFAULT_FOOTER_SECTIONS = [
  {
    ...
    links: [
      ...
      { name: 'Kurtis', link: '/category/kurtis' },
      { name: 'Ethnic Wear', link: '/category/ethnic-wear' },
  ...
  },
  {
    title: 'Categories',
    links: [
      { name: 'Western Wear', link: '/category/western-wear' },
      { name: 'Loungewear', link: '/category/loungewear' },
      { name: 'Festive', link: '/category/festive-wear' },
