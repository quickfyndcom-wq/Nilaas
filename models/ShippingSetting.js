...
const ShippingSettingSchema = new mongoose.Schema({
  ...
  estimatedDays: { type: String, default: "1-3" },
  // Checkout display labels (shown on cart / checkout)
  methodTitleFree: { type: String, default: "Free shipping" },
  methodTitlePaid: { type: String, default: "Standard shipping" },
  deliverySubtitle: { type: String, default: "Delivered within {days} days" },
  freePriceLabel: { type: String, default: "FREE" },
