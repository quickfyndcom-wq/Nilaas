    ...
    try {
        ...
        if (status || trackingId) {
            try {
                ...
                await fetch(`${process.env.NEXT_PUBLIC_APP_URL || 'https://nilaas.in'}/api/notifications/order-status`, {
                    method: 'POST',
                    headers: {
                ...
                if (existingOrder.shippingAddress?.phone) {
                    await fetch(`${process.env.NEXT_PUBLIC_APP_URL || 'https://nilaas.in'}/api/notifications/order-sms`, {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
